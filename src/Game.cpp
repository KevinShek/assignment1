...
void Game::run()
{
	...
	// somesystems should't (movement / input)
	while (m_running)
	{
...
{
	// TODO: Finish adding all properties of the player with the correct balues from the config file
...
void Game::sUserInput()
{
	...
	while (m_window.pollEvent(event))
	{
		...
		if (event.type == sf::Event::KeyPressed)
		{
			...
			{
			case sf::Keyboard::W:std::cout << "W Key Pressed\n";
		...
		if (event.type == sf::Event::KeyReleased)
		{
			switch (event.key.code)
			{
			case sf::Keyboard::W:std::cout << "W Key Released\n";
